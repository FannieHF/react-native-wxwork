...
RCT_EXPORT_METHOD(isWWAppInstalled:(RCTResponseSenderBlock)callback)
{
...
RCT_EXPORT_METHOD(getWWApiVersion:(RCTResponseSenderBlock)callback)
{
...
RCT_EXPORT_METHOD(openWWApp:(RCTResponseSenderBlock)callback)
{
    callback(@[([WWKApi openApp] ? [NSNull null] : INVOKE_FAILED)]);
}
