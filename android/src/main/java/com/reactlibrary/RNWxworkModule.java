...
public class RNWxworkModule extends ReactContextBaseJavaModule implements IWWAPIEventHandler {
  ...
  public RNWxworkModule(ReactApplicationContext reactContext) {
    super(reactContext);
 ...
 /**
   * fix Native module RNWxworkModule tried to override RNWxworkModule for module name RCTWeChat.
   * If this was your intention, return true from RNWxworkModule#canOverrideExistingModule() bug
   * @return
   */
  ...
  private static ArrayList<RNWxworkModule> modules = new ArrayList<>();
  ...
  public static void handleIntent(Intent intent) {
      for (RNWxworkModule mod : modules) {
  ...
  public void isWXAppSupportApi(Callback callback) {
      ...
      callback.invoke(null, wxapi.isWXAppSupportAPI());
  }
  ...
  public void isWWAppSupportApi(Callback callback) {
      ...
      callback.invoke(null, wwapi.isWWAppSupportAPI());
  }
  ...
  public void getApiVersion(Callback callback) {
      ...
      callback.invoke(null, wxapi.getWXAppSupportAPI());
  }
  ...
  public void getWWApiVersion(Callback callback) {
      ...
      callback.invoke(null, wwapi.getWWAppSupportAPI());
  }
  ...
  public void openWXApp(Callback callback) {
      ...
      callback.invoke(null, wxapi.openWXApp());
  }
  ...
  public void openWWApp(Callback callback) {
      ...
      callback.invoke(null, wwapi.openWWApp());
  }
  ...
  public void sendAuthRequest(String scope, String state, Callback callback) {
      ...
      req.scope = scope;
      req.state = state;
      callback.invoke(null, wxapi.sendReq(req));
  }
  ...
  public void sendWWAuthRequest(String schema, String appid, String agentid,  Callback callback) {
      ...
      req.agentId = agentid;
      req.state = "dd";
      callback.invoke(null, wwapi.sendMessage(req, this));
  }
  ...
  public void pay(ReadableMap data, Callback callback){
      ...
      payReq.appId = appId;
      callback.invoke(wxapi.sendReq(payReq) ? null : INVOKE_FAILED);
  }
      ...
      if (uri != null) {
          this._getImage(uri, new ResizeOptions(100, 100), new ImageCallback() {
              ...
              public void invoke(@Nullable Bitmap bitmap) {
                  RNWxworkModule.this._share(scene, data, bitmap, callback);
              }
          });
      } else {
          ...
          __jsonToImageUrlMedia(data, new MediaObjectCallback() {
              ...
              public void invoke(@Nullable WXMediaMessage.IMediaObject mediaObject) {
                  if (mediaObject == null) {
                      ...
                      RNWxworkModule.this._share(scene, data, thumbImage, mediaObject, callback);
                  }
              }
          });
          return;
